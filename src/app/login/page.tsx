...
export default function LoginPage() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        setLoading(true);
        // Simulate login for now or implement real auth
        setTimeout(() => {
            setLoading(false);
            console.log("Login attempt", { email, password });
            alert("Email login coming soon! Use Guest mode for now.");
        }, 1000);
    };
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-background p-4 relative overflow-hidden">
            ...
            <div className="absolute top-0 left-0 w-full h-full pointer-events-none overflow-hidden">
                <div className="absolute top-[-10%] right-[-5%] w-[500px] h-[500px] bg-primary/10 rounded-full blur-3xl mix-blend-multiply opacity-50"></div>
                <div className="absolute bottom-[-10%] left-[-5%] w-[500px] h-[500px] bg-accent/10 rounded-full blur-3xl mix-blend-multiply opacity-50"></div>
            </div>
